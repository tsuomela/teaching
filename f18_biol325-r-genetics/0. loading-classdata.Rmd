...
```{r}
read.table("randpedagogy.zip Folder/Getting-to-know-you_results.txt", header = T, sep = "\t")
getting.d <- read.table("randpedagogy.zip Folder/Getting-to-know-you_results.txt", header = T, sep = "\t")
```
